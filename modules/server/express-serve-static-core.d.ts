...
/// <reference types="npm:@types/node@18" />

import type { SendOptions } from "npm:@types/send@0";
...
import type { EventEmitter } from "npm:@types/node@18/events.d.ts";
import type * as http from "npm:@types/node@18/http.d.ts";
import type { ParsedQs } from "npm:@types/qs@6";
import type {
  Options as RangeParserOptions,
  Ranges as RangeParserRanges,
  Result as RangeParserResult,
} from "npm:@types/range-parser@1";
